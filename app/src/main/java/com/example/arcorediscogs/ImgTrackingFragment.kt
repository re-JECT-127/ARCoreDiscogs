...
internal class ImgTrackingFragment: Fragment(R.layout.img_tracking_fragment) {
    lateinit var arFrag: ArFragment
    var viewRenderable: ViewRenderable? = null

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        arFrag = fragmentManager?.findFragmentById(R.id.fragment) as ArFragment
...
/*    fun frameUpdate() {
        val fitToScanImg = getView()?.findViewById(R.id.fitToScanImg)
                ...
                when (it.trackingState) {
                    ...
                    TrackingState.TRACKING -> {
                        ...
                        if (anchors.isEmpty()) {
                            ...
                            viewRenderable?.view?.findViewById(R.id.txtImgTrack)?.text = it.name
